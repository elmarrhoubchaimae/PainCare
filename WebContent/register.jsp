  ...
  <div class="container py-5 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        ...
        <form class="formclass2" action="register" method="post">
          <div style ="text-align: center; display: flex; align-items: center; justify-content: center; padding-bottom: 20px;">
            <div style="color: #b1ded8 !important ; font-size: 35px; font-weight: bold;" >Sign up for&nbsp;  </div>
            <div style="color:#ff879a !important ; font-size: 35px; font-weight: bold;">PainCare </div>
          </div>
          <div class="form-outline mb-4">
            <label class="form-label" for="name">Name</label>
            <input type="name" id="name" name="name" class="form-control form-control-lg" placeholder="Name.." style="font-size:14px; color: rgba(0, 0, 0, 0.1);"/>
          ...
          <div class="form-outline mb-4">
            ...
            <input type="password" id="confirmPassword" name="confirmPassword" class="form-control form-control-lg" placeholder="Password.."style="font-size:14px; color: rgba(0, 0, 0, 0.5);"/>
          ...
          <!-- Submit button -->
          <button type="submit" value="S'inscrire" class="btn btn-primary btn-lg btn-getstarted" style=" margin-left:160px">Register</button>
